...
#ifndef BOOKLOOP_UNIMET_SWIFT_H
#define BOOKLOOP_UNIMET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="bookloop_unimet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15bookloop_unimet11AppDelegate")
...
SWIFT_CLASS("_TtC15bookloop_unimet17MainFlutterWindow")
