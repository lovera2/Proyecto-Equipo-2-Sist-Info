...
Widget _buildBookCard(String materialId, Map<String, dynamic> data) {
    ...
    final dynamic rawImage = data['image_base64'];
    ...
    try {
      if (imageBase64 != null && imageBase64.isNotEmpty) {
        ...
        imageWidget = const Center(child: Icon(Icons.book, size: 50, color: Colors.grey));
      }
    } catch (e) {imageWidget = const Center(child: Icon(Icons.error_outline, size: 50, color: Colors.red));
    }
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: unimetBlue),
        ),
        Text(
          author,
          maxLines: 1,
